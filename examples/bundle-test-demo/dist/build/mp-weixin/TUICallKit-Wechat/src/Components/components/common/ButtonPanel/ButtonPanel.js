...
const l = require('../../../../TUICallService/CallService/index.js'),
...
const h = () => '../../base/Grid/Grid.js',
  ...
  B = e.defineComponent({
    ...
    setup(h) {
      ...
      const { layout: T, config: y } = t.useButtonPanelLayout();
      e.watch(
        y,
        () => {
          const e = {},
      ...
      return (
        e.onMounted(() => {
          l.TUIStore.watch(c.StoreName.CALL, b, {
            notifyRangeWhenWatch: o.NAME.MYSELF,
          });
        }),
        e.onUnmounted(() => {
          l.TUIStore.unwatch(c.StoreName.CALL, b);
        }),
          ...
          e.e(
            {
              ...
              j: e.o(B),
              k: e.p({ unit: '%', layout: e.unref(T), focus: e.unref(p) }),
              l: e.unref(v),
            },
  ...
  T = e._export_sfc(B, [['__scopeId', 'data-v-e14ce8ee']]);
