...
const u = require('../../../config/button/ClosedPanelUI.js'),
    ...
    l.watch(
      ...
      () => {
        ...
        d.value === i.CallStatus.CALLING
          ? (T = I.value === i.CallRole.CALLER ? 'calling' : 'accept')
          : d.value === i.CallStatus.CONNECTED && (T = 'connected');
        let f = a.InitialUI;
        'close' === C.value && (f = u.closedPanelUI),
          (q.value =
            (null ==
            (r =
              null ==
              (o =
                ...
                (t =
                  null ==
                  (e = null == (l = null == f ? void 0 : f[v]) ? void 0 : l[c])
                    ? void 0
                    : e[S])
                  ? void 0
                  : t[T])
