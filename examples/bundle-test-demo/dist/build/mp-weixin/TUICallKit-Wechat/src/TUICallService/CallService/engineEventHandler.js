  ...
  N = class e {
    ...
    addListenTuiCallEngineEvent() {
      ...
      t
        ? (t.on(l.jv.ERROR, this._handleError, this),
          ...
          l.jv.CALL_MESSAGE &&
            t.on(l.jv.CALL_MESSAGE, this._handleCallMessage, this),
    ...
    _unNormalEventsManager(e, t) {
      ...
      switch (t) {
        ...
        case l.jv.NO_RESP: {
          ...
          L.update(_.StoreName.CALL, a.NAME.TOAST_INFO, {
            content: { key: l, options: { userList: i.join() } },
          }),
    ...
    async _handleNewInvitationReceived(e) {
      ...
      (this._callService._preDevicePermission =
        ...
        L.updateStore(T, _.StoreName.CALL),
    ...
    _handleUserAccept(e) {
      this._callerChangeToConnected(),
        L.update(_.StoreName.CALL, a.NAME.CALL_TIPS, {
          text: 'answered',
          duration: 2e3,
        }),
    ...
    _handleUserLeave(e) {
      ...
      if (
        ...
        L.update(_.StoreName.CALL, a.NAME.TOAST_INFO, {
          content: { key: n.CallTips.END_CALL, options: { userList: e } },
        });
      }
    ...
    async _handleSDKReady(e) {
      var t;
      let l = L.getData(_.StoreName.CALL, a.NAME.LOCAL_USER_INFO);
      (l = await s.getMyProfile(
        l.userId,
        null == (t = this._callService) ? void 0 : t.getTim()
      )),
        L.update(_.StoreName.CALL, a.NAME.LOCAL_USER_INFO, l),
        L.update(_.StoreName.CALL, a.NAME.LOCAL_USER_INFO_EXCLUDE_VOLUMN, l);
    }
    _handleKickedOut(e) {
      var t, l, i;
      console.log(`${a.NAME.PREFIX}kickOut event data: ${JSON.stringify(e)}.`),
        ...
        L.update(_.StoreName.CALL, a.NAME.CALL_TIPS, n.CallTips.KICK_OUT),
        null == (i = this._callService) || i._resetCallStore();
    }
    _messageSentByMe(e) {
      var t, a;
      ...
      if (!l) {
        if (
          ...
          return void L.update(
            _.StoreName.CALL,
            a.NAME.CALL_TIPS,
            n.CallTips.REMOTE_NETWORK_IS_POOR
          );
        if (
          t.find(
            (e) =>
          ...
          return void L.update(
            _.StoreName.CALL,
            a.NAME.CALL_TIPS,
            n.CallTips.LOCAL_NETWORK_IS_POOR
          );
      }
    }
    _handleUserUpdate(e) {
