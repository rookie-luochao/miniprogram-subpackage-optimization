...
const { t: o } = e.initVueI18n(e.messages),
  t = {
    ...
    computed: {
      ...
      contentrefreshText() {
        return (
          this.contentText.contentrefresh || o('uni-load-more.contentrefresh')
        );
      },
      contentnomoreText() {
        return (
          this.contentText.contentnomore || o('uni-load-more.contentnomore')
        );
      },
    },
    mounted() {},
...
const i = e._export_sfc(t, [
  [
    'render',
    function (n, o, t, i, c, A) {
      return e.e(
        {
          a:
            !c.webviewHide &&
            ('circle' === t.iconType ||
              ('auto' === t.iconType && 'android' === c.platform)) &&
            'loading' === t.status &&
            t.showIcon,
        },
        !c.webviewHide &&
          ...
          : !c.webviewHide && 'loading' === t.status && t.showIcon
            ? { k: c.imgBase64, l: t.iconSize + 'px', m: t.iconSize + 'px' }
            : {},
        {
          ...
          ? {
              o: e.t(
                'more' === t.status
                  ? A.contentdownText
                  : 'loading' === t.status
                    ? A.contentrefreshText
                    : A.contentnomoreText
              ),
              p: t.color,
            }
          : {},
        { q: e.o((...e) => A.onClick && A.onClick(...e)) }
      );
    },
  ],
]);
